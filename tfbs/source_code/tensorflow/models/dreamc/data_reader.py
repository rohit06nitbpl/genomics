...
from tfbs.source_code.tensorflow.pipeline.data_reader import DataReader


class TFBSAAFileReader(DataReader):
    ...
    def read(self, queue_pl, enqueue_op, n_epochs, dataset_type = 'train', log_data = False):
        ...
        for epoch in range(n_epochs):
            ...
            for input_file in input_files:
                ...
                if log_data:
                    f_data_log.writelines('processed: ' + input_file + 'Time: ' + str(time.time() - file_process_start_time) + '\n')
                    f_data_log.flush()
        ...
        if not coord_stop_requested:
            print 'All epochs have been read for Class:', self.class_type, ', Will request stop after 10 secs...'
            time.sleep(10)
